...
class gamedata {
  ...
  static void set tetrisFieldWidth(int w) {
    _tetrisFieldWidth = w;
  }
  ...
  void set tetriminoList(tetriminos t) {
    _tetriminoList = t;
  }
  ...
  void set currentTetrimino(tetrimino t) {
    _currentTetrimino = t;
  }
